using DotNet.EFCore.CodeFirst.Library.Constants;
using DotNet.EFCore.CodeFirst.MvcApp.Data;
using DotNet.EFCore.CodeFirst.MvcApp.Models;
using DotNet.EFCore.CodeFirst.MvcApp.Repository;
using Microsoft.AspNetCore.Mvc;
using Newtonsoft.Json;
using System.Diagnostics;

namespace DotNet.EFCore.CodeFirst.MvcApp.Controllers
{
    /// <summary>
    /// Home Controller
    /// </summary>
    public class HomeController : Controller
    {
        ...
        /// </summary>
        private readonly EFCoreCodeFirstDatabaseContext _dbContext;
        ...
        public HomeController(ILogger<HomeController> logger, EFCoreCodeFirstDatabaseContext dbContext)
        {
            _logger = logger;
